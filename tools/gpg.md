...
<pre>
<b>gpg --list-signatures</b>           Показывает подписи (сертификаты) в связке ключей или подписи во входных данных
<b>gpg --check-signatures</b>          Проверяет подписи (сертификаты) в связке ключей и обновляет их статус
